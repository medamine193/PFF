        ...
        <div className="py-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="mt-4 text-sm text-gray-600 dark:text-gray-400 max-w-md">
                Plateforme de prise de rendez-vous médicaux en ligne. Trouvez facilement un médecin et prenez
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 tracking-wider uppercase">Légal</h3>
              <ul className="mt-4 space-y-2">
                <li>
                  <Link
                    href="/privacy"
          ...
          <div className="mt-8 border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              &copy; {currentYear} MédecinsRDV. Tous droits réservés.
            </p>
